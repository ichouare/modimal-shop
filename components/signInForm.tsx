...
function SignInForm({ setAlreadyHave }: Tprops) {
    ...
    <section className="flex flex-col items-center gap-[30px]">
      ...
      >
        ...
        <Button
          ...
          variant="default"
          size="lg"
          className="w-full rounded-none h-[40px] cursor-pointer buttonSM bg-black"
        >
          Register Now
        </Button>
        <div className="w-full flex items-center justify-around  ">
          <p className=" text-black bodySM text-center">
            Already have an account?
          </p>
          <p
            className=" text-primary cursor-pointer buttonSM"
            onClick={() => setAlreadyHave(true)}
          >
            Log in
          </p>
        </div>
      ...
      >
        <div className="flex-1 h-full  flex flex-col items-center justify-center gap-[40px]">
          <span className="bodyLG">
            We’ve sent an email to nina@gmail.com to verify your email address
            and activate your account. the link in the email will expire in 24
            hours.
          </span>
          <span className="text-black bodyLG">
            {" "}
